=== SCM - Smart Currency Manager - Premium Variant for wcmp  ===
...
= How to use SCM (Smart Currency Manager)with WCMP =.
[youtube  https://www.youtube.com/watch?v=gUDGq5Fwpvo]


== DOCUMENTATION AND USAGE ==

Visit our documentation section on our website : [SCM DOCUMENTATION] (https://www.gajelabs.com/scd-documentation/)

= For marketplaces or Multi vendors sites =
 1- Go to "WooCommerce -> SCM Currencies -> CURRENCIES SETTINGS"
...
= Add "SCM - Smart Currency Manager" Widget (SCM Widget) =

 1- Go to the admin view under "Appearance > Widgets" and select the SCM Widget 
...
[SCM FAQ](https://gajelabs.com/frequently-asked-questions/)

== CHANGELOG ==
= 4.8.1 =
* Update the Plugin name to SCM - Smart Currency Manager
= 4.8.0 =
* Fix SCM Currency Settings integration in wcmp vendor dashboard 
* Auto installation of dependency plugin SCM Free variant 
= 4.7.9 =
* Fix vendor commission on email sends after an purchase 
= 4.7.8 =
* Remove some obsolete settings options on SCM currency settings in wcmp vendor dashboard 
* Change plugin name 
* Correct SCM currency settings integration in wcmp vendor dashbord menu for mobile view
= 4.7.7 =
...
* hithlight scm currency menu on wcmp dashboard after clicking on.
...
= 4.5.9 =
* Fix can't disbale variation on wcmp dashbord when scm is activated
